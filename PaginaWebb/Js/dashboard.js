...
//fin funcion showproducts
  ...
  .then(result=>{
    if (result.isConfirmed) {
      fetch(`http://localhost/api/productos/DeleteProductos?id=${id}`, {
        method: 'DELETE',
        headers: {
...
function updateProduct(e) {
  ...
  nuevoGuardar.addEventListener('click', () => {
    ...
    fetch('http://localhost/api/productos/updateProductos', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json'
      },
...
function CreateProduct() {
  ...
  fetch('http://localhost/api/productos/CreateProductos', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
